          ...
          <>
            ...
            <div className="bg-blue-50 p-4 rounded-lg my-4">
              ...
              <ol className="list-decimal list-inside text-blue-800 space-y-1 text-sm">
                <li>Find the config file in /assets/challenge-data/</li>
                <li>Use the entire file content as the JWT payload</li>
                <li>Use your User ID as the secret key</li>
                <li>Create the JWT using jwt.io with HS256 algorithm</li>
                <li>Submit the complete JWT token below</li>
              </ol>
            </div>
